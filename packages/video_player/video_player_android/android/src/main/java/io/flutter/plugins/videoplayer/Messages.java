...
public class Messages {
  ...
  public static class PreloadMessage {
    ...
    public @Nullable List<String> getUris() { return uris; }
    public void setUris(@Nullable List<String> setterArg) {
      this.uris = setterArg;
    }

    public static final class Builder {
      private @Nullable List<String> uris;
      public @NonNull Builder setUris(@Nullable List<String> setterArg) {
        this.uris = setterArg;
        return this;
      }
      public @NonNull PreloadMessage build() {
        PreloadMessage pigeonReturn = new PreloadMessage();
        pigeonReturn.setUris(uris);
        return pigeonReturn;
      }
    }
    @NonNull Map<String, Object> toMap() {
      Map<String, Object> toMapResult = new HashMap<>();
      toMapResult.put("uris", uris);
      return toMapResult;
    }
    static @NonNull PreloadMessage fromMap(@NonNull Map<String, Object> map) {
      PreloadMessage pigeonResult = new PreloadMessage();
      Object uris = map.get("uris");
      pigeonResult.setUris((List<String>)uris);
      return pigeonResult;
    }
  }
      ...
      } else 
{
  ...
  public interface AndroidVideoPlayerApi {
    void initialize();
    void preload(@NonNull PreloadMessage msg);
    ...
    static void setup(BinaryMessenger binaryMessenger, AndroidVideoPlayerApi api) {
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.AndroidVideoPlayerApi.preload", getCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            Map<String, Object> wrapped = new HashMap<>();
            try {
